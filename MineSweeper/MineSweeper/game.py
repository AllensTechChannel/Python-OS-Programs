...
print("Original project made by itspyguru at https://github.com/itspyguru/Python-Games/tree/master/MineSweeper (Ctrl+ Left Click to open link).") 
time.sleep(2)
print("Game has been modified for even more enjoyability.")
time.sleep(3)
...
os.chdir("MineSweeper/MineSweeper/") 
